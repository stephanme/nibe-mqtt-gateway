...
// Changes
// - use ESP_LOGx instead of Serial.print
// - use esp-idf and arduino-esp32 ethernet implementation (needs patch https://github.com/espressif/esp-idf/pull/12692)
// - enable SNTP service for time synchronization
// - replace Adafruit_NeoPixel by esp32-hal-rgb-led
...
#define MCP23S08InterruptPin 36  // IO36
 ...
 * @brief Relays.
 */
enum Relay { Relay1 = 0, Relay2 = 1, Relay3 = 2, Relay4 = 3 };

/**
 * @brief Inputs.
 */
enum OptoIn { OptoIn1 = 0, OptoIn2 = 1, OptoIn3 = 2, OptoIn4 = 3 };
...
class KMPProDinoESP32Class {
   public:
     ...
     * @brief Initialize ProDino ESP32 board.
     * @param board Initialize specific bard. Mandatory.
     * @param startEthernet If board has a Ethernet we can stop it if it isn't necessary. If true - starts Ethernet W5500 or false
     * - the Ethernet stays stopped.
     * @param startModem If board has GSM or LoRa module we can stop it if it isn't necessary. If true - starts module or false -
     * the module stays stopped.
     *
     * @return void
     */
    ...
    *               Values: SERIAL_5N1, SERIAL_6N1, SERIAL_7N1, SERIAL_8N1, SERIAL_5N2, SERIAL_6N2, SERIAL_7N2, SERIAL_8N2,
    SERIAL_5E1, SERIAL_6E1, SERIAL_7E1, SERIAL_8E1, SERIAL_5E2, SERIAL_6E2, SERIAL_7E2, SERIAL_8E2, SERIAL_5O1, SERIAL_6O1,
